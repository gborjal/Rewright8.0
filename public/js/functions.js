					...
					for(var k=0;k<arr[i].exers_info.task_datas.length;k++){
						...
						if(user_type==1){
							if(arr[i].exers_info.task_datas[k].resultScore){
								...
								li+= "&nbsp&nbsp&nbsp&nbsp<div class='chip light-blue-text accent-4 tooltipped' data-position='top' data-delay='50' data-tooltip='Generated Score'>Pending<i class='material-icons'>assessment</i></div>";
							}
							if(arr[i].exers_info.task_datas[k].adjustedResultScore){
								...
								li+= "&nbsp&nbsp&nbsp&nbsp<div class='chip light-blue-text accent-4 tooltipped' data-position='top' data-delay='50' data-tooltip='Adjusted Score''>Pending<i class='material-icons'>assessment</i></div>";
							}
						}else if(user_type==2){
							if(arr[i].exers_info.task_datas[k].resultScore){
								...
								li+= "&nbsp&nbsp&nbsp&nbsp<div class='chip light-blue-text accent-4 tooltipped' data-position='top' data-delay='50' data-tooltip='Status'>Pending<i class='material-icons'>play_arrow</i></div>";
							}
							if(arr[i].exers_info.task_datas[k].adjustedResultScore){
								...
								li+= "&nbsp&nbsp&nbsp&nbsp<div class='chip light-blue-text accent-4 tooltipped' data-position='top' data-delay='50' data-tooltip='Assessment'>Pending<i class='material-icons'>assessment</i></div>";
							}
						}
