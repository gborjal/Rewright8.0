					...
					for(var k=0;k<arr[i].exers_info.task_datas.length;k++){
						...
						if(user_type==1){
							...
							if(arr[i].exers_info.task_datas[k].resultScore){
								...
								li+= "&nbsp&nbsp&nbsp&nbsp<div class='chip teal-text darken-2 accent-4 tooltipped' data-position='top' data-delay='50' data-tooltip='Status'>Pending<i class='material-icons'>play_arrow</i></div>";
							}
							if(arr[i].exers_info.task_datas[k].adjustedResultScore){
								...
								li+= "&nbsp&nbsp&nbsp&nbsp<div class='chip teal-text darken-2 accent-4 tooltipped' data-position='top' data-delay='50' data-tooltip='Assessment'>Pending<i class='material-icons'>assessment</i></div>";
							}
						}
	...
	$.ajax({
        ...
        success:function(data){
				...
				for(var i=0;i< data.comments.length;i++){
			    	...
			    	if(comment['comment_id'] = 7) console.log(comment);
	...
	if($(this).attr('href') != undefined){
		if($(this).attr('href') ==='#top' ) {
			...
			if(active == '#post_disc'){
				...
				dataform.append('patient_ids',$('#patient_ids').val());
