...
//Route::middleware(['web', 'cors'])->group(function () {
	Route::prefix('/post')->group(function () {
		...
		Route::prefix('patient')->group(function () {
			Route::post('list', [projectsController::class,'postPatientDataList'])->name('postExerciseDataList')->middleware('web');	//ajax 
			Route::get('list', [projectsController::class,'postPatientDataList'])->middleware('web');
		});
